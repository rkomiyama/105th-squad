<template>
  <div>
    ...
    <p>
      ...
      certain other site features in the following ways: To improve our website in order to better 
      serve you; To administer a contest, promotion, survey or other site feature; To send periodic 
      emails regarding your order or other products and services; To follow up with them after 
      correspondence (live chat, email or phone inquiries)
    </p>

    <h2>How do we protect your information?</h2>
    <p>
      We only provide articles and information. We never ask for private information like credit 
      card numbers.
    </p>
    ...
    <p>
      ...
      We use cookies to compile aggregate data about site traffic and site interactions in order to
    ...
    <p>
      ...
      action, should a data breach occur we will notify users via in-site notification within 7 
      business days.
    </p>
    ...
    <p>
      ...
      We collect your email address in order to send information, respond to inquiries, and/or 
      other requests or questions. If at any time you would like to unsubscribe from receiving 
      future emails, you can email us at info@105thsquad.com and we will promptly remove you from 
      ALL correspondence.
    </p>
